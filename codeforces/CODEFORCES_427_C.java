...
public class CODEFORCES_427_C {
	...
	public static void main (String[] t) throws IOException {
		...
		while (!order.isEmpty ()) {
			int cur = order.pollFirst ();

			if (!vis[cur])
				dfs2 (cur, c++);
		}

		// min cost (and number of occurrences of that) in each component c
		int[] min = new int[c];
		int[] cnt = new int[c];
