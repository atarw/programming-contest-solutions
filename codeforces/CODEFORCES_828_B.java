...
public class CODEFORCES_828_B {
	...
	public static void main (String[] t) throws IOException {
		...
		else if (Math.max (maxx - minx, maxy - miny) + 1 > Math.min (N, M)) {
			out.print (-1);
		}
		else {
			out.print ((int) Math.pow (Math.max (maxx - minx, maxy - miny) + 1, 2) - cnt);
		}
