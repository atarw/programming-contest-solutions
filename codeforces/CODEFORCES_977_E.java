...
public class CODEFORCES_977_E {

	static int[] parent, rank;
	static List<Integer>[] list;

	public static void union (int item1, int item2) {
	...
	public static void main (String[] t) throws IOException {
		...
		List<Integer>[] cmp = new ArrayList[N];
		...
		for (int n = 0; n < N; ++n) {
			...
			for (int i = 0; i < cmp[n].size (); ++i)
				good &= (list[cmp[n].get (i)].size () == 2);
