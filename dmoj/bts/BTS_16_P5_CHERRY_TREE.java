...
public class BTS_16_P5_CHERRY_TREE {
	...
	public static void main (String [] t) throws IOException {
		...
		t = in.readLine ().split (" ");
		int N = Integer.parseInt (t [0]); C = Integer.parseInt (t [1]); K = Integer.parseInt (t [2]);
		
		cherries = new int [N]; branches = new int [N]; list = new ArrayList [N];
		...
		for (int n = 0, a, b, k; n < N - 1; ++n) {
			t = in.readLine ().split (" ");
			a = Integer.parseInt (t [0]) - 1; b = Integer.parseInt (t [1]) - 1; k = Integer.parseInt (t [2]);
