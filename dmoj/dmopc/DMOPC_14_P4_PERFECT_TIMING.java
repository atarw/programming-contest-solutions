...
public class DMOPC_14_P4_PERFECT_TIMING {
  public static void main (String [] args) throws IOException {
    ...
    c.set (Integer.parseInt (t [0]), Integer.parseInt (t [1]), Integer.parseInt (t [2]), Integer.parseInt (t [3]), Integer.parseInt (t [4]), Integer.parseInt (t [5]));
    ...
    if (!c.isLeapYear (c.get (Calendar.YEAR)) && c.get (Calendar.MONTH) == 2 && c.get (Calendar.DAY_OF_MONTH) == 29) {
