...
public class DMOPC_14_P4_SKETCHLEY_PARK {
	...
	public static void main (String[] args) throws IOException {
		...
		for (int i = 0; i + 8 < msg.length (); i++) {
			if (msg.charAt (i) == msg.charAt (i + 4) && msg.charAt (i + 1) == msg.charAt (i + 8) && msg.charAt (i + 2)
					!= msg.charAt (i + 3) && msg.charAt (i + 3) != msg.charAt (i + 5) && msg.charAt (i + 5) != msg
					.charAt (i + 6) && msg.charAt (i + 6) != msg.charAt (i + 7)) {
