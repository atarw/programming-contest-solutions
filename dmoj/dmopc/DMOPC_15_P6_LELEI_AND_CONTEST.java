//apparently fenwick trees can do range updates...still don't know what was wrong with my segment tree
// solution...probably didn't do the math correctly :P
...
public class DMOPC_15_P6_LELEI_AND_CONTEST {
	...
	public static void update_range (int l, int r, long val) {
		update_point (bit1, l, val);
		update_point (bit1, r + 1, -val);
		update_point (bit2, l, val * (l - 1));
		update_point (bit2, r + 1, -val * r);
	}
	...
	public static void main (String[] t) throws IOException {
		...
		for (int q = 0; q < Q; ++q) {
			...
			if (c == 1) {
				...
				out.println ((query (r) - query (l - 1)) % M);
			}
		}
