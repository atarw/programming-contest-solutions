			...
			if (curr.bx == ex && curr.by == ey) {
				...
				if (curr.px + 1 < R && grid [curr.px + 1][curr.py] != '#') {
					if (curr.px + 1 == curr.bx && curr.py == curr.by) {
						if (curr.bx + 1 < R && grid [curr.bx + 1][curr.by] != '#' && cache [curr.px + 1][curr.py][curr.bx + 1][curr.by] > cache [curr.px][curr.py][curr.bx][curr.by] + 1) {
							cache [curr.px + 1][curr.py][curr.bx + 1][curr.by] = cache [curr.px][curr.py][curr.bx][curr.by] + 1;
							q.offer (new State (curr.px + 1, curr.py, curr.bx + 1, curr.by));
						}
					}
					else if (cache [curr.px + 1][curr.py][curr.bx][curr.by] > cache [curr.px][curr.py][curr.bx][curr.by] + 1) {
				...
				if (curr.px - 1 >= 0 && grid [curr.px - 1][curr.py] != '#') {
					if (curr.bx == curr.px - 1 && curr.by == curr.py) {
						if (curr.bx - 1 >= 0 && grid [curr.bx - 1][curr.by] != '#' && cache [curr.px - 1][curr.py][curr.bx - 1][curr.by] > cache [curr.px][curr.py][curr.bx][curr.by] + 1) {
							cache [curr.px - 1][curr.py][curr.bx - 1][curr.by] = cache [curr.px][curr.py][curr.bx][curr.by] + 1;
							q.offer (new State (curr.px - 1, curr.py, curr.bx - 1, curr.by));
						}
					}
				...
				if (curr.py + 1 < C && grid [curr.px][curr.py + 1] != '#') {
					if (curr.bx == curr.px && curr.by == curr.py + 1) {
						if (curr.by + 1 < C && grid [curr.bx][curr.by + 1] != '#' && cache [curr.px][curr.py + 1][curr.bx][curr.by + 1] > cache [curr.px][curr.py][curr.bx][curr.by] + 1) {
							cache [curr.px][curr.py + 1][curr.bx][curr.by + 1] = cache [curr.px][curr.py][curr.bx][curr.by] + 1;
							q.offer (new State (curr.px, curr.py + 1, curr.bx, curr.by + 1));
						}
					}
					else if (cache [curr.px][curr.py + 1][curr.bx][curr.by] > cache [curr.px][curr.py][curr.bx][curr.by] + 1) {
				...
				if (curr.py - 1 >= 0 && grid [curr.px][curr.py - 1] != '#') {
					if (curr.bx == curr.px && curr.by == curr.py - 1) {
						if (curr.by - 1 >= 0 && grid [curr.bx][curr.by - 1] != '#' && cache [curr.px][curr.py - 1][curr.bx][curr.by - 1] > cache [curr.px][curr.py][curr.bx][curr.by] + 1) {
							cache [curr.px][curr.py - 1][curr.bx][curr.by - 1] = cache [curr.px][curr.py][curr.bx][curr.by] + 1;
							q.offer (new State (curr.px, curr.py - 1, curr.bx, curr.by - 1));
						}
					}
