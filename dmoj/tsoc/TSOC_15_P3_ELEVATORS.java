...
public class TSOC_15_P3_ELEVATORS {
  ...
  public static final NavigableMap <Integer, NavigableSet <Integer>> map = new TreeMap <Integer, NavigableSet <Integer>> ();
  ...
  public static int g (int S, int E) {
    ...
    else if (low != null && high != null /*&& !map.get (high).isEmpty () && !map.get (low).isEmpty ()*/ && high - S == S - low) {
