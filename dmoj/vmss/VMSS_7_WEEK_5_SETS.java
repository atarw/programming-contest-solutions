...
public class VMSS_7_WEEK_5_SETS {
  public static void main (String [] args) throws IOException {
    ...
    NavigableMap <Character, NavigableSet <Character>> map = new TreeMap <Character, NavigableSet <Character>> ();//stores set name to set contents
    Map <Character, Set <Character>> links = new HashMap <Character, Set <Character>> ();//stores set name to list of sets which contain the key set
