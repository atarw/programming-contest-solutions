...
public class SPOJ_PPATH {
	...
	public static List <Integer> next (int n) {
		...
		for (int i = 0; i < 4; ++i) {
			...
			for (int d = 0; d < 10; ++d) {
				...
				p = Character.getNumericValue (arr [3]) + Character.getNumericValue (arr [2]) * 10 + Character.getNumericValue (arr [1]) * 100 + Character.getNumericValue (arr [0]) * 1000;
	...
	public static void main (String [] t) throws IOException {
		...
		while (T --> 0) {
			...
			Arrays.fill (cache, Integer.MAX_VALUE); cache [x] = 0;
