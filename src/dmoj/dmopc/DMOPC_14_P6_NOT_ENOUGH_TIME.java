...
public class DMOPC_14_P6_NOT_ENOUGH_TIME {
  ...
  public static void main (String [] t) throws IOException {
    ...
    for (int n = 0; n < N; n++) {
      t = in.readLine ().split (" ");
      p [n][0] = Integer.parseInt (t [0]); p [n][1] = Integer.parseInt (t [2]); p [n][2] = Integer.parseInt (t [4]);
      v [n][0] = Integer.parseInt (t [1]); v [n][1] = Integer.parseInt (t [3]); v [n][2] = Integer.parseInt (t [5]);
    }
