...
public class FHC_17_P3_MANIC_MOVING {
	...
	public static void main (String [] t) throws IOException {
		...
		for (int tt = 1; tt <= T; ++tt) {
			...
			int [] S = new int [K], D = new int [K]; parent = new int [N];
			...
			for (int m = 0, a, b, g; m < M; ++m) {
				a = in.iscan () - 1; b = in.iscan () - 1; g = in.iscan ();
				union (a, b);
			...
			while (!q.isEmpty ()) {
				...
				if (curr.k == K) {
					...
					if (curr.c == 2 && find (curr.n) == find (D [curr.k - curr.c]) && find (D [curr.k - curr.c]) == find (D [curr.k - curr.c + 1])) {
						dp [curr.n][curr.k][curr.c] += dist [curr.n][D [curr.k - curr.c]] + dist [D [curr.k - curr.c]][D [curr.k - curr.c + 1]];
						ans = Math.min (ans, dp [curr.n][curr.k][curr.c]);	
					}
					...
					if (curr.c != 2) // can load
						if (find (curr.n) == find (S [curr.k]) && dp [S [curr.k]][curr.k + 1][curr.c + 1] > dp [curr.n][curr.k][curr.c] + dist [curr.n][S [curr.k]]) {
							dp [S [curr.k]][curr.k + 1][curr.c + 1] = dp [curr.n][curr.k][curr.c] + dist [curr.n][S [curr.k]];
							q.offer (new State (S [curr.k], curr.k + 1, curr.c + 1));
						}
					
					if (curr.c != 0)  // can deliver
						if (find (curr.n) == find (D [curr.k - curr.c]) && dp [D [curr.k - curr.c]][curr.k][curr.c - 1] > dp [curr.n][curr.k][curr.c] + dist [curr.n][D [curr.k - curr.c]]) {
							dp [D [curr.k - curr.c]][curr.k][curr.c - 1] = dp [curr.n][curr.k][curr.c] + dist [curr.n][D [curr.k - curr.c]];
